...
def calculate_demographic_data(print_data=True):
    ...
    higher_education_rich = ((higher_education & (df['salary'] == '>50K')).mean() * 100).round(1)

    # What percentage of people without advanced education make more than 50K?
    lower_education_rich = ((~higher_education & (df['salary'] == '>50K')).mean() * 100).round(1)
    ...
    highest_earning_country_percentage = ((country_salary / country_counts) * 100).max().round(1)
